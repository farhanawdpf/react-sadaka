...
const ManageVolunteer = () => {
  ...
  const itemDelete = (id) => {
    axios
      .post(
        "http://localhost/react-sadaka/php/volunteers/delete_volunteer?id=" +
          id
      )
    ...
    axios
      .get(
        "http://localhost/react-sadaka/php/volunteers/list_volunteers.php"
      )
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <NavLink to="/addVolunteer">
                <button className="btn btn-info btn-lg ">Add_Volunteer</button>
              </NavLink>
            </div>
