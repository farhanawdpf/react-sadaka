...
const EditUser = () => {
    ...
    useEffect(() => {
        axios
            .get(
                `http://localhost/raju/react-project-raju/react-sadaka/php/user/edit_user.php?id=${id}`
            )
            .then((res) => {
    ...
    const save = () => {
        ...
        axios
            .post(
                "http://localhost/raju/react-project-raju/react-sadaka/php/user/update_users.php",
                formdata,
                {
                    headers: {
